...
// value of CCNT
unsigned int read_ccnt_int(void);
void write_ccnt(unsigned int);

// value of PMN{n}
// counter = The counter to read (e.g. 0 for PMN0, 1 for PMN1)
unsigned int read_pmn_int(unsigned int counter);
void write_pmn(unsigned int counter, unsigned int value);
